...
import image1 from "../../public/images/imagen1.avif";
  ...
  <section className="!py-12 !bg-white ">
    <div className="!max-w-4xl !mx-auto !px-4 sm:!px-8 flex flex-col !gap-4">
      ...
      <p className="!mb-4 !text-gray-700 !text-lg !text-center !leading-relaxed">
        En <strong>CyE Tech</strong> nos apasiona acercarte la tecnología al
        mejor precio. Ofrecemos un catálogo curado de productos electrónicos,
        gadgets y soluciones digitales diseñadas para mejorar tu día a día.
        Nuestro compromiso es brindarte una experiencia de compra segura, con
        envíos rápidos a todo el país y atención personalizada en cada etapa del
        proceso.
        <br />
        <br />
        Ya sea que busques artículos para tu hogar, trabajo o emprendimiento, en
        CyE Tech vas a encontrar calidad, confianza y soporte. Estamos presentes
        en{" "}
        <Link
          href="https://www.instagram.com/cyetech/profilecard/?igsh=enl0ZmNjbmE5czk3"
          target="_blank"
          className="text-[#f02d34] hover:underline"
        >
          Instagram
        </Link>{" "}
        y{" "}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
        <div className="bg-white rounded-xl shadow p-6 flex flex-col items-center text-center">
          ...
          <p className="text-gray-700 italic mb-2">
            “Excelente atención y productos de calidad. ¡Recomiendo 100%!”
          </p>
        ...
        <div className="bg-white rounded-xl shadow p-6 flex flex-col items-center text-center">
          <FaStar className="text-yellow-400 text-2xl mb-2" />
          <p className="text-gray-700 italic mb-2">
            “El envío fue rapidísimo y el producto llegó perfecto.”
          </p>
        ...
        <div className="bg-white rounded-xl shadow p-6 flex flex-col items-center text-center">
          <FaStar className="text-yellow-400 text-2xl mb-2" />
          <p className="text-gray-700 italic mb-2">
            “Siempre encuentro el regalo ideal y a buen precio.”
          </p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-6">
        <div className="flex flex-col items-center text-center gap-2">
          ...
          <span className="text-sm text-gray-500">
            A todo el país y en 24hs en Córdoba capital.
          </span>
        </div>
        <div className="flex flex-col items-center text-center gap-2">
          ...
          <span className="text-sm text-gray-500">
            Tus datos y pagos protegidos con tecnología de punta.
          </span>
        </div>
        <div className="flex flex-col items-center text-center gap-2">
          ...
          <span className="text-sm text-gray-500">
            Te asesoramos por WhatsApp antes y después de tu compra.
          </span>
        </div>
        <div className="flex flex-col items-center text-center gap-2">
          ...
          <span className="text-sm text-gray-500">
            Más de 500 valoraciones positivas en redes y Mercado Libre.
          </span>
        </div>
      </div>
    </div>
